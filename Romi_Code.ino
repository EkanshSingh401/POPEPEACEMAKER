...
void loop() {
  ...
  if (robotState == ROBOT_MOVE) {
    ...
    double turnTime = 0.80; // target time for a turn is 0.55 seconds
    double totalTurnTime = 0.90 * numTurns; // but the code doesn't work so the actual time for a turn is 0.65 seconds
